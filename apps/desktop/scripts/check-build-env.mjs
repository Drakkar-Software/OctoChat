...
// The 'octochat' namespace was deleted in the 2026-06-15 consolidation; the
// 'octospaces' namespace was renamed to 'dk' in the dk-spaces migration (Infra
// commit 9a0bf38) — any other value baked into the bundle results in 404s on
// every sync call.
...
if (_url && !_url.includes('localhost') && _ns !== 'dk') {
  ...
  console.error('The deployed server only accepts the "dk" namespace (renamed from "octospaces").');
