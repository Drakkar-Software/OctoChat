/**
 * Pure message-text parsing: split a message into prose, external-link,
 * `#channel`- and `@user`-mention segments, and detect whether a message mentions
 * a given user. No rendering, no I/O — the UI's link/navigation behavior
 * (`openUrl` / `openRoom`) lives in the app.
 */
